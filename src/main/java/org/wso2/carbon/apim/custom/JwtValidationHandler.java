...
public class JwtValidationHandler extends AbstractHandler {
    ...
    public boolean handleRequest(MessageContext messageContext) {
    	...
    	log.info("================ Custom JWT Authentication Handler Engaged in Request Path ===========================");
    	...
    	if (jwtToken != null && !jwtToken.isEmpty()) {        
		    ...
		    // we need to set all the properties required for other handlers in here which we extracted from the jwt
    ...
    public boolean handleResponse(MessageContext messageContext) {
    	log.info("====================== Custom JWT Authentication Handler Engaged in Response Path =======================");
        return true;
    }
	...
	private void authenticateInfo(MessageContext messageContext, AuthenticationContext authContext) {
		...
		log.info("Printing auth context" + authContext.toString());
	...
	private void setAPIParametersToMessageContext(MessageContext messageContext) {
		...
		log.info("Printing messageContext" + messageContext.toString());
